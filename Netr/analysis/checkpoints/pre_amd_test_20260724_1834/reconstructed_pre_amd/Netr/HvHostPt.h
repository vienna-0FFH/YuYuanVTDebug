...
#define HV_HOST_PT_PML4_SLOT             255              // private low-half canonical slot
#define HV_HOST_PT_PHYS_BASE_VA          0x00007F8000000000ULL  // 255 << 39; matches PML4[255]
#define HV_HOST_PT_PHYS_PD_COUNT         64               // 64 个 PD = 64 GB
#define HV_HOST_PT_PHYS_BYTES            (HV_HOST_PT_PHYS_PD_COUNT * (1ULL << 30))  // 64 GB

C_ASSERT(((HV_HOST_PT_PHYS_BASE_VA >> 39) & 0x1FFULL) ==
         HV_HOST_PT_PML4_SLOT);
