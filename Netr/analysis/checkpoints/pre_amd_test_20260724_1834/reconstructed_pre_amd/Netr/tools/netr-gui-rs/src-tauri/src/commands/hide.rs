...
const PROCESS_REQUEST_SIZE: usize = 4 + 260 * 2;

fn process_request(pid: u32) -> [u8; PROCESS_REQUEST_SIZE] {
    let mut request = [0u8; PROCESS_REQUEST_SIZE];
