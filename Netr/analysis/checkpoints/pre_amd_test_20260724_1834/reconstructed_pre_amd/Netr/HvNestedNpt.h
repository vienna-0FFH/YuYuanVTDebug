...
// 嵌套 NPT 上下文最大数量
#define MAX_NESTED_NPT_CONTEXTS     64
#define NESTED_NPT_PREALLOC_PAGES   32
...
typedef struct _NESTED_NPT_CONTEXT {
    ...
    PVOID PreallocatedPages[NESTED_NPT_PREALLOC_PAGES];
    PHYSICAL_ADDRESS PreallocatedPhysical[NESTED_NPT_PREALLOC_PAGES];
    BOOLEAN Provisioned;
