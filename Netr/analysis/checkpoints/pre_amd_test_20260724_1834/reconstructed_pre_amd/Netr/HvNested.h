...
typedef enum _HV_NESTED_LIFECYCLE_STATE {
    HvNestedStateUninitialized = 0,
    HvNestedStateInitializing  = 1,
    HvNestedStateReady         = 2,
    HvNestedStateRunning       = 3,
    HvNestedStateQuiescing     = 4
} HV_NESTED_LIFECYCLE_STATE;

#define HV_NESTED_EVENT_VERSION       1u
#define HV_NESTED_EVENT_CAPACITY      256u

typedef enum _HV_NESTED_EVENT_TYPE {
    HvNestedEventNone = 0,
    HvNestedEventEnabled,
    HvNestedEventDisabled,
    HvNestedEventVmxon,
    HvNestedEventVmEntry,
    HvNestedEventVmExit,
    HvNestedEventVmInstructionError,
    HvNestedEventSvmVmrun,
    HvNestedEventSvmExit,
    HvNestedEventTranslationFailure,
    HvNestedEventPoolExhausted,
    HvNestedEventQuiesceBegin,
    HvNestedEventQuiesceComplete
} HV_NESTED_EVENT_TYPE;

typedef struct _HV_NESTED_EVENT {
    UINT64 Sequence;
    UINT64 Tsc;
    ...
    UINT64 Information1;
    UINT64 Information2;
} HV_NESTED_EVENT, *PHV_NESTED_EVENT;

typedef struct _HV_NESTED_EVENT_BATCH {
    ULONG Version;
    ULONG EventSize;
    ULONG Count;
    ULONG Capacity;
    ...
    UINT64 NextSequence;
    UINT64 LostEvents;
    HV_NESTED_EVENT Events[1];
} HV_NESTED_EVENT_BATCH, *PHV_NESTED_EVENT_BATCH;
