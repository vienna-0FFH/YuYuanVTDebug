...
/* Authorization implementation is retained, but enforcement is optional.
 * The current project/test workflow does not require authentication, so the
 * default is open. A future licensed build must opt in explicitly. */
#ifndef HV_LICENSE_ENFORCEMENT
#define HV_LICENSE_ENFORCEMENT 0
#endif

/* Independent development escape hatch for an enforcement-enabled build. */
#ifndef HV_LICENSE_ENABLE_DEV_BYPASS
#define HV_LICENSE_ENABLE_DEV_BYPASS 0
#endif
