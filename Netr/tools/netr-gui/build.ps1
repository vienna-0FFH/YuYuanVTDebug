...
# ----------------------------------------------------------------- 5) run
Step "运行 PyInstaller"
Write-Host "  python -m PyInstaller $($piArgs -join ' ')" -ForegroundColor DarkGray
