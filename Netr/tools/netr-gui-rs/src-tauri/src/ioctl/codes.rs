...
pub const IOCTL_HV_BRIDGE_REGISTER: u32 = ctl_code(0x45);
pub const IOCTL_HV_BRIDGE_BIND_TARGET: u32 = ctl_code(0x46);
pub const IOCTL_HV_BRIDGE_UNBIND_TARGET: u32 = ctl_code(0x47);
pub const IOCTL_HV_BRIDGE_SCRUB_PEB: u32 = ctl_code(0x48);
...
pub const IOCTL_HV_GET_ANTIANTIDEBUG_STATUS: u32 = ctl_code(0x58);
pub const IOCTL_HV_SET_PRIVATE_DEBUG_OBJECT: u32 = ctl_code(0x59);
...
pub const IOCTL_HV_MEMORY_READ_EX: u32 = ctl_code(0x85);
pub const IOCTL_HV_MEMORY_WRITE_EX: u32 = ctl_code(0x86);
...
pub const IOCTL_HV_DBG_WAIT_EVENT: u32 = ctl_code(0x102);
pub const IOCTL_HV_DBG_CONTINUE: u32 = ctl_code(0x103);
...
pub const IOCTL_HV_DBG_RESOLVE_THREAD: u32 = ctl_code(0x10B);
pub const IOCTL_HV_DBG_STEP_CLEAR: u32 = ctl_code(0x10C);
pub const IOCTL_HV_BRIDGE_DBGK_WAIT: u32 = ctl_code(0x10D);
pub const IOCTL_HV_BRIDGE_DBGK_CONTINUE: u32 = ctl_code(0x10E);
pub const IOCTL_HV_BRIDGE_DBGK_SYMBOLS: u32 = ctl_code(0x10F);
pub const IOCTL_HV_BRIDGE_PENDING_HWBP: u32 = ctl_code(0x110);
