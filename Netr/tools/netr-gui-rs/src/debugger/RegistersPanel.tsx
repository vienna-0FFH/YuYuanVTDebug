...
export function RegistersPanel() {
  ...
  const { selectedTid, ctx, setCtx, setAddress } = session;
        ...
        {!ctx ? (
          ...
          REG_KEYS.map((k) => {
            ...
            return (
              <div
                key={k}
                className={cn("flex items-center gap-1 px-1 py-0.5 hover:bg-accent/40", k === "rip" && "text-info")}
              >
