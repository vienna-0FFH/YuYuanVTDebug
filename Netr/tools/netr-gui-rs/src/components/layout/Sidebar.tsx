...
const groups: NavGroup[] = [
  ...
  },
  {
    title: "安全",
    items: [
      { to: "/service", label: "安全服务", icon: HardDrive, shortcut: "Ctrl+2" },
      { to: "/status", label: "运行状态", icon: Activity, shortcut: "Ctrl+3", needsDriver: true },
    ],
  },
  {
    title: "安全 / 隐藏",
  ...
  },
  {
    title: "调试",
    items: [
      { to: "/launch-debugger", label: "内置调试器", icon: Bug, shortcut: "Ctrl+4", needsDriver: true },
